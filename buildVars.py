...
addon_info = {
	...
	"addon_url": "https://github.com/reyes2005/battery_check/",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/reyes2005/battery_check",
...
pythonSources = [os.path.join("addon", "globalPlugins", "battery_check", "*.py"), os.path.join("addon", "globalPlugins", "battery_check", "lib", "*.py")]
